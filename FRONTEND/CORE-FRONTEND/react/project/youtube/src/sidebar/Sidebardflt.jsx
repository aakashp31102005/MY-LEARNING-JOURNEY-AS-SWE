import shorticn from '../assets/shortsicn.svg'
import subicn from '../assets/subscriptionicn.png'
import './sidebar.css'
function Sidebardflt(){
    return(
       <>
       <div className="sbdft">
        
        <div className="homec outer">
        <svg  className='home icn' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"  viewBox="0 0 26 26">
       ...
       <div className="shortc outer"><img className='short icn' src={shorticn} alt="" />
       <h5>Shorts</h5>
       </div>
        
        <div className="subc outer"><img className='sub icn' src={subicn} alt="" />
        <h5>Subscription</h5>
        </div>
