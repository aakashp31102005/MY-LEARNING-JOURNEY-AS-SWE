import vricon from '../assets/microphone.png';
import './Topbar.css'
function Searchbar(){
    return(
        <>
        <div className="Searchdiv">
                ...
                <div className='sicn'>
                <svg style={{width:20,height:20,marginLeft:1}} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"  viewBox="0 0 50 50">
              ...
              <img className='vricn' src={vricon} alt="#"/>
